...
<div class="about_section layout_padding">
 <div class="container">
    <div class="row">
       ...
       <div class="col-md-6">
          <div class="about_img"><img src="<?php echo bloginfo('template_url');?>/assets/images/about-img.png"></div>
       </div>
    </div>
 </div>
</div>
           ...
           <div class="row">
              <div class="col-md-12">
                 <div class="testimonial_section_2">
                    <h4 class="client_name_text">Monila <span class="quick_icon"><img src="<?php echo bloginfo('template_url');?>/assets/images/quick-icon.png"></span></h4>
